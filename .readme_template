GITHUB_REPONAME[![GITHUB_REPONAME](https://i.griefed.de/images/2020/10/17/template.png)](https://github.com/CREATOR_NAME/CREATOR_REPO)
...
[![Docker Cloud Automated build](https://img.shields.io/docker/cloud/automated/griefed/DOCKERREPONAME?label=Docker%20build&style=flat-square)](https://hub.docker.com/repository/docker/griefed/DOCKER_REPONAME)
...
![GITHUB_REPONAME](EXAMPLE_IMAGE)

---

Creates a Container which runs [CREATOR_NAME's](https://github.com/CREATOR_NAME) [CREATOR_REPO](https://github.com/CREATOR_NAME/CREATOR_REPO), with [lsiobase/alpine](https://hub.docker.com/r/lsiobase/alpine) as the base image, as seen on EXAMPLE_SITE_IF_EXISTS.
